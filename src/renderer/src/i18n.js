...
const ENGLISH_MESSAGES = Object.freeze({
  ...
  '理论与参考': 'Theory & References',
  '理论、图例与主要参考文献': 'Theory, Figures & Key References',
  '模型框架': 'Model Framework',
  'StreamSim 面向复杂三维地表场景，将面元或体元辐射传输、温度与能量平衡、多角度成像和外部统计分析连接为统一流程。下列图例来自当前软件的实际场景与结果界面。': 'StreamSim provides a unified workflow for complex 3D land-surface scenes, connecting facet- or voxel-based radiative transfer, temperature and energy balance, multi-angle imaging, and external statistical analysis. The figures below come from actual scenes and result views in the current software.',
  '三维场景与物化属性': '3D Scene & Physical Properties',
  'Facet / Voxel 辐射传输': 'Facet / Voxel Radiative Transfer',
  '能量平衡与温度': 'Energy Balance & Temperature',
  '多角度影像与统计': 'Multi-angle Images & Statistics',
  '主要图例': 'Key Figures',
  '单击图像可放大查看。': 'Click an image to enlarge it.',
  '森林场景构建与三维预览': 'Forest Scene Construction and 3D Preview',
  '森林场景构建': 'Forest Scene Construction',
  '树木实例、太阳—传感器几何和场景边界的统一预览。': 'Unified preview of tree instances, sun–sensor geometry, and scene bounds.',
  '城市建筑三维场景': 'Urban Building 3D Scene',
  '城市建筑场景': 'Urban Building Scene',
  '建筑群三维结构及面元/体元热辐射计算对象。': '3D urban geometry and facet/voxel thermal-radiation targets.',
  '作物场景表面温度分布': 'Crop-scene Surface-temperature Distribution',
  '作物温度分布': 'Crop Temperature Distribution',
  '行播作物场景的空间温度差异及阴影效应。': 'Spatial temperature variation and shadow effects in row-planted crops.',
  '光伏阵列三维场景': 'Photovoltaic-array 3D Scene',
  '光伏阵列': 'Photovoltaic Array',
  '太阳能板几何、光谱物性与热电能量过程。': 'Solar-panel geometry, spectral properties, and coupled thermal–electrical energy processes.',
  '船舶与海面场景': 'Ship and Sea-surface Scene',
  '船舶与海面': 'Ship and Sea Surface',
  '复杂目标表面温度、多角度热红外和水体背景。': 'Complex-target surface temperature, multi-angle thermal infrared, and water background.',
  '热红外角度效应极坐标图': 'Thermal-infrared Angular-effect Polar Plot',
  '热红外角度效应': 'Thermal-infrared Angular Effect',
  '不同观测天顶角与方位角下的方向性温度分布。': 'Directional temperature distribution across view zenith and azimuth angles.',
  '主要参考文献': 'Key References',
  '覆盖辐射度—能量平衡、GPU 光线追踪、温度方向性及 STREAM 系统。': 'Covering radiosity–energy balance, GPU ray tracing, temperature directionality, and the STREAM system.',
  '卞尊健等，光学遥感三维计算机模拟模型的研究进展与应用。': 'Bian, Z., et al. Research Progress and Applications of Three-dimensional Computer Simulation Models for Optical Remote Sensing.',
  '遥感学报': 'National Remote Sensing Bulletin',
  '中国科学院空天信息创新研究院红外遥感组 · 卞尊健、曹彪、历华、杜永明、肖青、柳钦火': 'Infrared Remote Sensing Group, Aerospace Information Research Institute, Chinese Academy of Sciences · Zunjian Bian, Biao Cao, Hua Li, Yongming Du, Qing Xiao, and Qinhuo Liu',
  '图例预览': 'Figure Preview',
  '实体': 'Solid',
  '线框': 'Wireframe',
  '温度': 'Temperature',
